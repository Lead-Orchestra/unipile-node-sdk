...
describe('MessagingResource', () => {
	...
	describe('getAllChats', () => {
		//--------------------------------------------------------------------------
		it('should return a validated ChatList ' +
			'on getAllChats ' +
	...
	describe('sendMessage', () => {
		//--------------------------------------------------------------------------
		it('should return a validated MessageSent response ' +
			'on sendMessage ' +
			'when ', async () => {
			// try {
			const chat = await client.messaging.getAllChats({ limit: 1 });
	...
	describe('startNewChat', () => {
		//--------------------------------------------------------------------------
		it('should return a validated ChatStarted response ' +
			'on startNewChat ' +
			'when ', async () => {
			// try {
	...
	describe('getAllAttendeesFromChat', () => {
		//--------------------------------------------------------------------------
		it('should return a validated ChatAttendeeList ' +
	...
	describe('getAllMessages', () => {
		//--------------------------------------------------------------------------
		it('should return a validated MessageList ' +
			'on getAllMessages ' +
			'when no arguments', async () => {
			// try {
	...
	describe('setChatStatus', () => {
		//--------------------------------------------------------------------------
		it('should return a validated ChatPatched response ' +
			'on setChatStatus ' +
			'when ', async () => {
			try {
				const chat = await client.messaging.getAllChats({ limit: 1 });
