...
export const MailAccountWithSourceStatusSchema = Type.Composite([
	Type.Omit(MailAccountSchema, ['sources']),
	SourceStatusSchema,
]);
...
export const MailingAccountSupportedProviders: AccountSupportedProvider[] = [
	'GOOGLE',
	'MAIL',
	'OUTLOOK',
];
