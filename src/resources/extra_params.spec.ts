...
describe('extra_params', () => {
	...
	describe('GET', () => {
		//--------------------------------------------------------------------------
		it(
			'should inject extra_params as query string ' + 'on GET ' + 'when no input params',
			async () => {
	...
	describe('POST | PUT', () => {
		//--------------------------------------------------------------------------
		it.skip(
			'should inject extra_params in body ' + 'on POST ' + 'when no input params',
			async () => {}
		);
		//--------------------------------------------------------------------------
		it(
	...
	describe('DELETE', () => {
		//--------------------------------------------------------------------------
		it(
			'should inject extra_params as query string ' + 'on DELETE ' + 'when no input params',
			async () => {
