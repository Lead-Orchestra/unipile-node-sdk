...
describe('AccountResource', () => {
	...
	describe('getAll', () => {
		//--------------------------------------------------------------------------
		it('should return a validated AccountList ' + 'on getAll ' + 'when no arguments', async () => {
	...
	describe('getOne', () => {
		//--------------------------------------------------------------------------
		it('should return a validated Account ' + 'on getOne ' + 'when no arguments', async () => {
			// try {
			const result = await client.account.getAll();
	...
	describe('connect', () => {
		//--------------------------------------------------------------------------
		it('should return a validated AccountCreated response ' +
			'on connect ' +
			'when no checkpoint', async () => {
			try {
	...
	describe('reconnect', () => {
		//--------------------------------------------------------------------------
		it('should return a validated AccountReconnected response ' +
			'on reconnect ' +
			'when no checkpoint', async () => {
			// try {
			const result = await client.account.connect({
	...
	describe('connectWhatsapp', () => {
		//--------------------------------------------------------------------------
		it('should return a validated PostQrCodeBasedAccount response ' +
			'on connectWhatsapp ' +
			'when ', async () => {
			// try {
	...
	describe('reconnectWhatsapp', () => {
		...
		it('should return a validated PostQrCodeBasedAccount response  ' +
			 ...
			 */
			const result = await client.account.reconnectWhatsapp(config.WHATSAPP_RECONNECT_ACCOUNT_ID);
	...
	describe('reconnectTelegram', () => {
		...
		it('should return a validated PostQrCodeBasedAccount response  ' +
			 ...
			 * @todo Consider using a container image ?
			 */
			const result = await client.account.reconnectTelegram(config.TELEGRAM_RECONNECT_ACCOUNT_ID);
	...
	describe('connectLinkedin', () => {
		//--------------------------------------------------------------------------
		it('should return a validated AccountCreated or Checkpoint response ' +
			'on connectLinkedin ' +
			'when ', async () => {
			// try {
			...
			expect(result.object === 'AccountCreated' || result.object === 'Checkpoint').toBe(true);
	...
	describe('reconnectLinkedin', () => {
		//--------------------------------------------------------------------------
		it('should return a validated AccountReconnected or Checkpoint response  ' +
			...
			expect(result.object === 'AccountReconnected' || result.object === 'Checkpoint').toBe(true);
		});
	});
	//----------------------------------------------------------------------------
	...
	describe('delete', () => {
		//--------------------------------------------------------------------------
		it('should return a validated AccountDeleted response ' + 'on delete ' + 'when ', async () => {
			// try {
			const result = await client.account.connect({
				provider: 'MAIL',
				imap_port: config.MAIL_IMAP_PORT,
	...
	describe('solveCodeCheckpoint', () => {
		//--------------------------------------------------------------------------
		it('should return a validated AccountCreated, AccountReconnected or Checkpoint response ' +
	...
	describe('createHostedAuthLink', () => {
		//--------------------------------------------------------------------------
		it('should return a validated HostedAuthUrl response ' +
	...
	describe('resyncLinkedinAccount', () => {
		//--------------------------------------------------------------------------
		it('should return a validated AccountResync ' +
