...
export type CancelUserInvitationBody = Static<typeof CancelUserInvitationBodySchema>;
...
export type CancelUserInvitationApiResponse = Static<typeof CancelUserInvitationResponseSchema>;

// export const cancelUserUserInvitationResponseOpenApiSchema =
//   makeOpenApiSchemaGetter(CancelUserInvitationResponseSchema);

/**  */
export const CancelUserInvitationApiResponseValidator = TypeCompiler.Compile(
	CancelUserInvitationResponseSchema
);
