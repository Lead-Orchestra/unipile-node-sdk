...
export const ChatFeaturesSchema = Type.Union([Type.Literal('reactions'), Type.Literal('reply')]);
...
export const ChatSchema = Type.Object({
	...
	content_type: Type.Optional(
		Type.Union([Type.Literal('inmail'), Type.Literal('sponsored'), Type.Literal('linkedin_offer')])
	),
