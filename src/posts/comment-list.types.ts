...
export const LINKEDIN_COMMENT_LIST_LIMIT_DEFAULT = LINKEDIN_COMMENT_LIST_LIMIT_MAX;
...
export const PostCommentListQueryValidator = TypeCompiler.Compile(PostCommentListQuerySchema);
...
export type PostCommentListDecodedCursor = Static<typeof PostCommentListDecodedCursorSchema>;
...
export const CommentListApiResponseSchema = Type.Object({
	...
	items: Type.Array(
		Type.Composite([Type.Object({ object: Type.Literal('Comment') }), CommentSchema])
	),
	cursor: Type.Union([Type.String(), Type.Null()]),
	total_items: Type.Union([Type.Number(), Type.Null()]),
});

export type PostCommentListApiResponse = Static<typeof CommentListApiResponseSchema>;
...
/**  */
export const PostCommentListApiResponseValidator = TypeCompiler.Compile(
	CommentListApiResponseSchema
);
