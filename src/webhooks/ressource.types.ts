...
export const WebhookMailTriggerEventSchema = StringEnum(['mail_sent', 'mail_received']);
...
export const WebhookSchema = Type.Union([WebhookAutoSchema, WebhookTriggerSchema]);
