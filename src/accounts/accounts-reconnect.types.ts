...
export type AccountReconnectApiResponse = Static<typeof AccountReconnectApiResponseSchema>;

/**  */
export const AccountReconnectApiResponseValidator = TypeCompiler.Compile(
	AccountReconnectApiResponseSchema
);
...
/**  */
export const AccountSolveCheckpointApiResponseValidator = TypeCompiler.Compile(
	AccountSolveCheckpointApiResponseSchema
);
