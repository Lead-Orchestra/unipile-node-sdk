...
export const LinkedinUserProfileSchema = Type.Object({
	...
	contact_info: Type.Optional(
		Type.Object({
			...
			socials: Type.Optional(Type.Array(Type.Object({ type: Type.String(), name: Type.String() }))),
		})
	),
...
export const TwitterUserProfileSchema = Type.Object({
	...
	has_extended_profile: Type.Optional(Type.Union([Type.Null(), Type.Boolean()])),
	notifications: Type.Optional(Type.Union([Type.Null(), Type.Boolean()])),

	// Not found in twitter documentation but exist in response
	advertiser_account_type: Type.Optional(Type.Union([Type.Null(), Type.String()])),
	business_profile_state: Type.Optional(Type.Union([Type.Null(), Type.String()])),
	require_some_consent: Type.Optional(Type.Union([Type.Null(), Type.Boolean()])),
});
...
export const LinkedinAccountOwnerProfileSchema = Type.Object({
	...
	recruiter: Type.Union([
		...
		Type.Object({
			error: Type.Union([Type.Literal('MULTIPLE_SESSIONS'), Type.Literal('DISCONNECTED')]),
		}),
		Type.Null(),
	]),
...
export const LinkedinPostSchema = Type.Object({
	...
	repost_id: Type.Optional(Type.String({ description: 'The republication ID.' })),
...
export const InvitationSchema = Type.Object({
	...
	inviter: Type.Optional(
		Type.Object({
			inviter_name: Type.String(),
			inviter_id: Type.String(),
			inviter_public_identifier: Type.String(),
			inviter_description: Type.Union([Type.String(), Type.Null()]),
		})
	),
