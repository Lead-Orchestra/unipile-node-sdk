...
describe('AccountResource', () => {
	...
	describe('connect', () => {
		//--------------------------------------------------------------------------
		it(
			'should return a validated AccountCreated response ' + 'on connect ' + 'when no checkpoint',
			async () => {
				try {
	...
	describe('createHostedAuthLink', () => {
		//--------------------------------------------------------------------------
		it(
			'should return a validated HostedAuthUrl response ' + 'on createHostedAuthLink ' + 'when ',
			async () => {
				// try {
	...
	describe('resyncLinkedinAccount', () => {
		//--------------------------------------------------------------------------
		it(
			'should return a validated AccountResync ' + 'on resyncLinkedinAccount ' + 'when ',
			async () => {
