import type { MessagingProvider } from '../client.js';
...
type LinkedinPostNewChatOptions =
	| LinkedinClassicPostNewChatInputOptions
	| LinkedinSalesPostNewChatInputOptions
	| LinkedinRecruiterPostNewChatInputOptions;
...
export function isLinkedinClassicPostNewChatInputOptions(
	options: LinkedinPostNewChatOptions
): options is LinkedinClassicPostNewChatInputOptions {
	return options.api === 'classic' && options.inmail !== undefined;
}

export function isLinkedinRecruiterPostNewChatInputOptions(
	options: LinkedinPostNewChatOptions
): options is LinkedinRecruiterPostNewChatInputOptions {
