...
export const UserPostListQueryValidator = TypeCompiler.Compile(UserPostListQuerySchema);
...
export type UserPostListApiResponse = Static<typeof UserPostListApiResponseSchema>;
