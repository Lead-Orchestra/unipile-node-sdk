...
describe('MessagingResource', () => {
	...
	describe('getAllChats', () => {
		//--------------------------------------------------------------------------
		it(
			'should return a validated ChatList ' + 'on getAllChats ' + 'when no arguments',
			async () => {
				// try {
	...
	describe('getChat', () => {
		//--------------------------------------------------------------------------
		it('should return a validated Chat ' + 'on getChat ' + 'when no arguments', async () => {
			// try {
	...
	describe('sendMessage', () => {
		//--------------------------------------------------------------------------
		it(
			'should return a validated MessageSent response ' + 'on sendMessage ' + 'when ',
			async () => {
				// try {
				const chat = await client.messaging.getAllChats({ limit: 1 });
	...
	describe('startNewChat', () => {
		//--------------------------------------------------------------------------
		it(
			'should return a validated ChatStarted response ' + 'on startNewChat ' + 'when ',
			async () => {
				// try {
				...
				const result = await client.messaging.startNewChat({
					...
					attendees_ids: [attendee?.provider_id ?? 'expected an attendee_provider_id'],
	...
	describe('getAllAttendeesFromChat', () => {
		//--------------------------------------------------------------------------
		it(
			'should return a validated ChatAttendeeList ' + 'on getAllAttendeesFromChat ' + 'when ',
			async () => {
				// try {
				const chat = await client.messaging.getAllChats({ limit: 1 });
				const resultAttendees = await client.messaging.getAllAttendeesFromChat(chat.items[0].id);
	...
	describe('getMessage', () => {
		//--------------------------------------------------------------------------
		it('should return a validated Message ' + 'on getMessage ' + 'when ', async () => {
			// try {
			const message = await client.messaging.getAllMessages({ limit: 1 });
			const resultGetMessage = await client.messaging.getMessage(message.items[0].id);
	...
	describe('getAllMessages', () => {
		//--------------------------------------------------------------------------
		it(
			'should return a validated MessageList ' + 'on getAllMessages ' + 'when no arguments',
			async () => {
				// try {
	...
	describe('getAllMessagesFromAttendee', () => {
		//--------------------------------------------------------------------------
		it(
			'should return a validated MessageList ' + 'on getAllMessagesFromAttendee ' + 'when ',
			async () => {
				// try {
	...
	describe('getAllChatsFromAttendee', () => {
		//--------------------------------------------------------------------------
		it(
			'should return a validated MessageList ' + 'on getAllChatsFromAttendee ' + 'when ',
			async () => {
				// try {
				const account = await client.account.getAll({ limit: 1 });
				const account_id = account.items[0].id;
	...
	describe('getMessageAttachment', () => {
		//--------------------------------------------------------------------------
		it('should return a Blob ' + 'on getMessageAttachment ' + 'when ', async () => {
			// try {
			...
			expect(resultSend.object).toBe('MessageSent');
			expect(resultSend.message_id === null || typeof resultSend.message_id === 'string').toBe(
				true
			);
	...
	describe('getAllAttendees', () => {
		//--------------------------------------------------------------------------
		it(
			'should return a validated ChatAttendeeList ' + 'on getAllAttendees ' + 'when ',
			async () => {
				// try {
				const account = await client.account.getAll({ limit: 1 });
				const account_id = account.items[0].id;
	...
	describe('getAttendee', () => {
		//--------------------------------------------------------------------------
		it('should return a validated ChatAttendee ' + 'on getAttendee ' + 'when ', async () => {
			// try {
			const account = await client.account.getAll({ limit: 1 });
			const account_id = account.items[0].id;
			const attendee = await client.messaging.getAllAttendees({
	...
	describe('setChatStatus', () => {
		//--------------------------------------------------------------------------
		it(
			'should return a validated ChatPatched response ' + 'on setChatStatus ' + 'when ',
			async () => {
				try {
					const chat = await client.messaging.getAllChats({ limit: 1 });
					//   console.log(chat);
