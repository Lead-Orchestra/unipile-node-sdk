...
import type { SupportedProvider } from '../client.js';
...
export type LinkedinBasicAuthenticationInput = Omit<
	Static<typeof AccountCreateLinkedinBasicBodySchema>,
	'provider'
>;
export type LinkedinCookieAuthenticationInput = Omit<
	Static<typeof AccountCreateLinkedinCookieBodySchema>,
	'provider'
>;

/** PostInstagramAccountInput */
export type PostInstagramAccountInput = Omit<
	Static<typeof AccountCreateInstagramBodySchema>,
	'disabled_features' | 'provider'
>;

/** PostTwitterAccountInput */
export type PostTwitterAccountInput = Omit<
	Static<typeof AccountCreateTwitterBodySchema>,
	'disabled_features' | 'provider'
>;

/** PostMessengerAccountInput */
export type PostMessengerAccountInput = Omit<
	Static<typeof AccountCreateMessengerBodySchema>,
	'disabled_features' | 'provider'
>;
...
export type PostHostedAuthLinkInput =
	| HostedAuthConnectionLinkInput
	| HostedAuthReconnectionLinkInput;
