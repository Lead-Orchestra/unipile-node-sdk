...
export type MailSupportedAccountTypes = Static<typeof MailSupportedAccountTypesSchema>;
...
export const BaseMailMetaSchema = Type.Composite([
	...
	Type.Object({
		...
		in_reply_to: Type.Optional(Type.Object({ message_id: Type.String(), id: UniqueIdSchema })),
...
export const MailFullSchema = Type.Composite([
	...
	Type.Object({
		...
		body: Type.String(),
		headers: Type.Optional(Type.Array(Type.Object({ name: Type.String(), value: Type.String() }))),
	}),
]);
...
/** */
export const PartialMailSchema = Type.Union([MailReferenceSchema, MailMetaSchema, MailFullSchema]);
