...
import { accountSourceProviderSchema, uniqueIdSchema } from './utils.schema.js';
...
export const getWebhooksResponseSchema = Type.Object({
	...
	items: Type.Array(
		Type.Composite([Type.Object({ object: Type.Literal('Webhook') }), webhookSchema])
	),
});
...
export const postWebhookInputSchema = Type.Union([
