...
import { CursorParamSchema, ShortLimitParamSchema } from '../common/query-parameters.type.js';
...
export const UserInvitationSentListDecodedCursorValidator = TypeCompiler.Compile(
	UserInvitationSentListDecodedCursorSchema
);

export type UserInvitationSentListQuery = Static<typeof UserInvitationSentListQuerySchema>;
...
const UserInvitationSentListApiResponseSchema = Type.Object({
	...
	items: Type.Array(
		Type.Composite([Type.Object({ object: Type.Literal('InvitationSent') }), InvitationSchema])
	),
...
/**  */
export const UserInvitationSentListApiResponseValidator = TypeCompiler.Compile(
	UserInvitationSentListApiResponseSchema
);
