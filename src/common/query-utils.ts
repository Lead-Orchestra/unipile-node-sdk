...
export const parseNestPayload = (
	payload: any,
	rules: Partial<Record<'number' | 'boolean' | 'array' | 'json' | 'comma_separated_list', string[]>>
) => {
	try {
 ...
 */
const parseValue = (type: string, value: any): number | boolean | string | any[] => {
 ...
 */
const parseNestedObject = (key: string, [next, ...nestedKeys]: string[], value: any): object => {
 ...
 */
const mergeDeepObjects = (baseObj: { [key: string]: any }, update: { [key: string]: any }): any => {
