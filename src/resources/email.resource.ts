import {
	type GetAllEmailsInput,
	type GetAllFoldersInput,
	type GetEmailAttachmentByProviderIdInput,
	type GetEmailAttachmentInput,
	type RequestOptions,
	type SendEmailInput,
	type UnipileClient,
	type UpdateEmailByProviderIdInput,
...
import {
	type MailDeletedApiResponse,
	MailDeletedApiResponseValidator,
} from '../mails/mail.delete.types.js';
import {
	type MailSentApiResponse,
	MailSentApiResponseValidator,
} from '../mails/mail.send.types.js';
import { type MailApiResponse, MailApiResponseValidator } from '../mails/mail.types.js';
import {
	type MailUpdatedApiResponse,
	MailUpdatedApiResponseValidator,
} from '../mails/mail.update.types.js';
import {
	type MailListApiResponse,
	MailListApiResponseValidator,
} from '../mails/mails-list.types.js';
 ...
 */
type EmailMethodCallableByProviderId<
	TReturn,
	TArgs1 extends unknown[],
	TArgs2 extends unknown[],
	TArgs3 extends unknown[],
> = {
...
export class EmailResource {
	...
	constructor(private client: UnipileClient) {
		...
		this.getEmailAttachment = this._getEmailAttachment.bind(
			this
		) as EmailResource['getEmailAttachment'];
	...
	async getAll(
		input: GetAllEmailsInput = {},
		options?: RequestOptions
	): Promise<MailListApiResponse> {
	...
	private async _getEmailAttachment(
		input: GetEmailAttachmentInput,
		options?: RequestOptions
	): Promise<Blob> {
