...
import { StringEnum, type UniqueId } from '../common/common.types.js';
...
export const AccountResyncQueryValidator = TypeCompiler.Compile(AccountResyncQuerySchema);
...
export const AccountResyncResponseSchema = Type.Object({
	...
	status: StringEnum(['SYNC_STARTED', 'SYNC_RUNNING', 'SYNC_DONE', 'SYNC_ERROR'], {
		description:
...
export type AccountResyncApiResponse = Static<typeof AccountResyncResponseSchema>;

export const AccountResyncResponseValidator = TypeCompiler.Compile(AccountResyncResponseSchema);
