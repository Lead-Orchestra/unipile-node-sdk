...
import type { MailAttendee } from '../types/index.js';
...
describe('EmailResource', () => {
	...
	describe('getAll', () => {
		//--------------------------------------------------------------------------
		it('should return a validated EmailList ' + 'on getAll ' + 'when account_id', async () => {
			try {
	...
	describe('getOne', () => {
		//--------------------------------------------------------------------------
		it('should return a validated Email ' + 'on getOne ' + 'when mail Id', async () => {
			// try {
		...
		it('should return a validated Email ' + 'on getOne.byId ' + 'when mail Id', async () => {
			// try {
	...
	describe('delete', () => {
		//--------------------------------------------------------------------------
		it('should return a validated EmailDeleted ' + 'on delete ' + 'when mail Id', async () => {
			// try {
		...
		//--------------------------------------------------------------------------
		it('should return a validated EmailDeleted ' + 'on delete.byId ' + 'when mail Id', async () => {
			// try {
	...
	describe('update', () => {
		//--------------------------------------------------------------------------
		it('should return a validated EmailUpdated ' + 'on update ' + 'when mail Id', async () => {
			// try {
		...
		//--------------------------------------------------------------------------
		it('should return a validated EmailUpdated ' + 'on update.byId ' + 'when mail Id', async () => {
			// try {
	...
	describe('getOneFolder', () => {
		//--------------------------------------------------------------------------
		it('should return a validated Folder ' + 'on getOneFolder ' + 'when folder Id', async () => {
			// try {
