...
import type { AttachmentPostQuery } from '../mails/mail.send.types.js';
import type { MessageDraftAttachment } from '../messaging/messages/ressource.types.js';
...
export const CreatePostOptionsSchema = Type.Union([CreatePostTwitterOptionsSchema]);
...
export const CreatePostBodyValidator = TypeCompiler.Compile(CreatePostBodySchema);
