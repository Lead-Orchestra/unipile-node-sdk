...
export const UTCDateTimeMsType = TypeSystem.Type<UTCDateTimeMs>('UTCDateTimeMs', (options, value) =>
	isUTCDateTimeMs(value)
);
 ...
 *
 */
export const UnixTimeMsType = TypeSystem.Type<UnixTimeMs>('UnixTimeMs', (options, value) =>
	isUnixTimeMs(value)
);
...
export const HourMinuteTimeType = TypeSystem.Type<HourMinuteTime>(
	'HourMinuteTime',
	(options, value) => isHourMinuteTime(value)
);
