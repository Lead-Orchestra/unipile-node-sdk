...
import { HostedAuthTokenCreateSchema, HostedAuthTokenReconnectSchema } from './resource.types.js';
...
/** */
export type HostedAuthCreateLinkBody = Static<typeof HostedAuthCreateLinkBodySchema>;
/** */
export type HostedAuthReconnectLinkBody = Static<typeof HostedAuthReconnectLinkBodySchema>;

/** */
export const HostedAuthLinkBodyValidator = TypeCompiler.Compile(HostedAuthLinkBodySchema);
...
/** */
export type HostedAuthLinkResponse = Static<typeof HostedAuthLinkResponseSchema>;
...
export type HostedAuthWatchStatusQueryParams = Static<typeof HostedAuthWatchStatusSchema>;
export const HostedAuthWatchStatusQueryParamsValidator = TypeCompiler.Compile(
	HostedAuthWatchStatusSchema
);
export const HostedAuthLinkResponseValidator = TypeCompiler.Compile(HostedAuthLinkResponseSchema);
