...
export const FolderListApiResponseSchema = Type.Object(
	{
		...
		items: Type.Array(
			Type.Intersect([Type.Object({ object: Type.Literal('Folder') }), FolderBaseSchema])
		),
	},
 ...
 *
 */
export const FolderListQueryValidator = TypeCompiler.Compile(FolderListQuerySchema);
