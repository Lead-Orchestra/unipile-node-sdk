 ...
 *
 */
export const ChatAttendeeListQueryValidator = TypeCompiler.Compile(ChatAttendeeListQuerySchema);
...
export type ChatAttendeeByChatListApiResponse = Omit<ChatAttendeeListApiResponse, 'cursor'>;
