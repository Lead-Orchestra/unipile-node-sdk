...
describe('UserResource', () => {
	...
	describe('getProfile', () => {
		//--------------------------------------------------------------------------
		it.only('should return UserProfile for any account provider' +
			'on getProfile ' +
			'when identifier', async () => {
			try {
				const accounts = await client.account.getAll({ limit: 1 }, { extra_params });
		...
		it('should return a validated UserProfile ' +
			'on getProfile ' +
			'when linkedIn account id ' +
			'and linkedIn options', async () => {
			// try {
			...
			//     JSON.stringify(accounts.items[0], null, 2),
			//   );
			const account_id = accounts.items.filter((acc) => acc.type === 'LINKEDIN')[0].id;
	...
	describe('getOwnProfile', () => {
		//--------------------------------------------------------------------------
		it('should return a validated AccountOwnerProfile ' +
			'on getOwnProfile ' +
			'when linkedIn account Id', async () => {
			// try {
	...
	describe('sendInvitation', () => {
		//--------------------------------------------------------------------------
		it('should return a validated UserInvitationSent ' +
			'on sendInvitation ' +
			'when linkedIn account id ' +
			'and message', async () => {
			// try {
	...
	describe('getAllInvitationsSent', () => {
		//--------------------------------------------------------------------------
		it('should return a validated InvitationList ' +
	...
	describe('cancelInvitationSent', () => {
		//--------------------------------------------------------------------------
		it('should return a validated InvitationCanceled ' +
			'on cancelInvitationSent ' +
			'when linkedIn account Id ' +
			'and invitation Id', async () => {
			// try {
			const accounts = await client.account.getAll({ limit: 1 });
			//   accounts.items = [accounts.items[0]];
			//   console.log(
			...
			const invitation_id = (await client.users.getAllInvitationsSent({ account_id })).items[0].id;
	...
	describe('getAllPosts', () => {
		//--------------------------------------------------------------------------
		it('should return a validated PostList ' +
			'on getAllPosts ' +
			'when linkedIn account Id ' +
			'and identifier', async () => {
			// try {
			const accounts = await client.account.getAll({ limit: 1 });
			//   accounts.items = [accounts.items[0]];
			//   console.log(
	...
	describe('getPost', () => {
		//--------------------------------------------------------------------------
		it('should return a validated Post ' +
			'on getPost ' +
			'when linkedIn account Id ' +
			'and post Id', async () => {
			// try {
	...
	describe('sendPostComment', () => {
		//--------------------------------------------------------------------------
		it('should return a validated CommentSent ' +
			'on sendPostComment ' +
	...
	describe('createPost', () => {
		//--------------------------------------------------------------------------
		it.skip('should return a validated PostCreated ' +
			'on createPost ' +
			'when linkedIn account Id' +
			'and content', async () => {
			// try {
	...
	describe('getAllPostComments', () => {
		//--------------------------------------------------------------------------
		it('should return a validated CommentList ' +
	...
	describe('sendPostReaction', () => {
		//--------------------------------------------------------------------------
		it('should return a validated ReactionAdded ' +
			'on sendPostReaction ' +
			'when linkedIn account Id, post Id' +
			'and reaction', async () => {
			// try {
	...
	describe('getAllRelations', () => {
		//--------------------------------------------------------------------------
		it('should return a validated UserRelationsList ' +
			'on getAllRelations ' +
			'when linkedIn account Id', async () => {
			// try {
			const accounts = await client.account.getAll({ limit: 1 });
	...
	describe('getCompanyProfile', () => {
		//--------------------------------------------------------------------------
		it('should return a validated CompanyProfile ' +
			'on getCompanyProfile ' +
			'when linkedIn account Id' +
			'and company name', async () => {
			// try {
			const accounts = await client.account.getAll({ limit: 1 });
			//   accounts.items = [accounts.items[0]];
			//   console.log(
