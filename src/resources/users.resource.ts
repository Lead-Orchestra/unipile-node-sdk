...
import {
	type LinkedinCompanyProfileApiResponse,
	LinkedinCompanyProfileApiResponseValidator,
} from '../linkedin/company.js';
import {
	type PostCommentListApiResponse,
	PostCommentListApiResponseValidator,
} from '../posts/comment-list.types.js';
import {
	type CommentPostResponse,
	CommentPostResponseValidator,
} from '../posts/comment-send.types.js';
import {
	type CreatePostResponse,
	CreatePostResponseValidator,
} from '../posts/post-create.types.js';
import {
	type AccountOwnerProfileApiResponse,
	AccountOwnerProfileApiResponseValidator,
} from '../users/account-owner-profile.js';
import { type UserPostApiResponse, UserPostApiResponseValidator } from '../users/post.types.js';
import {
	type AddPostReactionResponse,
	AddPostReactionResponseValidator,
} from '../users/reaction-add.types.js';
import {
	type CancelUserInvitationApiResponse,
	CancelUserInvitationApiResponseValidator,
} from '../users/user-invitation-cancel.types.js';
import {
	type UserInvitationSentListApiResponse,
	UserInvitationSentListApiResponseValidator,
} from '../users/user-invitation-sent-list.types.js';
import {
	type UserInviteApiResponse,
	UserInviteApiResponseValidator,
} from '../users/user-invite.types.js';
import {
	type UserPostListApiResponse,
	UserPostListApiResponseValidator,
} from '../users/user-post-list.types.js';
import {
	type UserProfileApiResponse,
	UserProfileApiResponseValidator,
} from '../users/user-profile.types.js';
import {
	type UserRelationsListApiResponse,
	UserRelationsListApiResponseValidator,
} from '../users/user-relations-list.types.js';
...
export class UsersResource {
	...
	async getProfile(
		...
		if (linkedin_sections)
			parameters.linkedin_sections =
				typeof linkedin_sections === 'string' ? linkedin_sections : linkedin_sections.join(',');
	...
	async getOwnProfile(
		account_id: string,
		options?: RequestOptions
	): Promise<AccountOwnerProfileApiResponse> {
		return await this.client.request.send({
			path: ['users', 'me'],
			method: 'GET',
			options,
	...
	async getAllRelations(
		input: GetAllRelationsInput,
		options?: RequestOptions
	): Promise<UserRelationsListApiResponse> {
	...
	async getAllPosts(
		...
		options?: RequestOptions
	): Promise<UserPostListApiResponse> {
	...
	async getAllPostComments(
		input: GetAllPostCommentsInput,
		options?: RequestOptions
	): Promise<PostCommentListApiResponse> {
	...
	async sendPostReaction(
		input: SendPostReactionInput,
		options?: RequestOptions
	): Promise<AddPostReactionResponse> {
		return await this.client.request.send({
			path: ['posts', 'reaction'],
			method: 'POST',
			body: {
	...
	async getCompanyProfile(
		...
		options?: RequestOptions
	): Promise<LinkedinCompanyProfileApiResponse> {
