...
describe('WebhookResource', () => {
	...
	describe('getAll', () => {
		//--------------------------------------------------------------------------
		it('should return a validated WebhookList ' + 'on getAll ' + 'when no arguments', async () => {
			// try {
	...
	describe('create', () => {
		//--------------------------------------------------------------------------
		it('should return a validated WebhookCreated ' + 'on create ' + 'when ', async () => {
			// try {
			...
			const resultDelete = await client.webhook.delete(resultCreate.webhook_id);
	...
	describe('delete', () => {
		//--------------------------------------------------------------------------
		it('should return a validated WebhookDeleted ' + 'on delete ' + 'when  ', async () => {
			// try {
			const resultCreate = await client.webhook.create({
				request_url: 'https://www.rpdr.com/werk',
				name: 'test_wh',
