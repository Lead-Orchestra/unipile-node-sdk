...
export const ChatListDecodedCursorValidator = TypeCompiler.Compile(ChatListDecodedCursorSchema);
 ...
 *
 */
export const ChatListQuerySchema = Type.Union([ChatListBaseQuerySchema, ListCursorQuerySchema]);
...
export const ChatListResponseSchema = Type.Object({
	...
	items: Type.Array(Type.Composite([Type.Object({ object: Type.Literal('Chat') }), ChatSchema])),
