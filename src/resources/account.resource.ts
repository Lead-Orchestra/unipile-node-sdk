...
import { type AccountApiResponse, AccountApiResponseValidator } from '../accounts/account.types.js';
import {
	type AccountConnectApiResponse,
	AccountConnectApiResponseValidator,
} from '../accounts/accounts-create.types.js';
import {
	type AccountDeletedApiResponse,
	AccountDeletedApiResponseValidator,
} from '../accounts/accounts-delete.types.js';
import {
	type AccountListApiResponse,
	AccountListResponseValidator,
} from '../accounts/accounts-list.schema.js';
import {
	type AccountReconnectApiResponse,
	AccountReconnectApiResponseValidator,
	type AccountSolveCheckpointApiResponse,
	AccountSolveCheckpointApiResponseValidator,
} from '../accounts/accounts-reconnect.types.js';
import {
	type AccountResyncApiResponse,
	type AccountResyncInput,
	AccountResyncResponseValidator,
} from '../accounts/accounts-resync.types.js';
import { UniqueIdValidator } from '../common/common.types.js';
import {
	type HostedAuthLinkResponse,
	HostedAuthLinkResponseValidator,
} from '../hosted/hosted-auth-link.types.js';
import {
	type ConnectAccountInput,
	type GetAccountsInput,
	InvalidInputTypeError,
	type LinkedinBasicAuthenticationInput,
	type LinkedinCookieAuthenticationInput,
	type Output,
	type PostCodeCheckpointInput,
	type PostHostedAuthLinkInput,
	type PostInstagramAccountInput,
	type PostMessengerAccountInput,
	type PostTwitterAccountInput,
...
export class AccountResource {
	...
	async reconnectWhatsapp(
		account_id: string,
		options?: RequestOptions
	): Promise<Output.PostQrCodeBasedAccount> {
	...
	async connectLinkedin(
		input: LinkedinBasicAuthenticationInput,
		options?: RequestOptions
	): Promise<AccountConnectApiResponse> {
		return await this.client.request.send({
			path: ['accounts'],
	...
	async connectInstagram(
		input: PostInstagramAccountInput,
		options?: RequestOptions
	): Promise<AccountConnectApiResponse> {
		return await this.client.request.send({
			path: ['accounts'],
	...
	async connectMessenger(
		input: PostMessengerAccountInput,
		options?: RequestOptions
	): Promise<AccountConnectApiResponse> {
		return await this.client.request.send({
			path: ['accounts'],
	...
	async resyncLinkedinAccount(
		input: AccountResyncInput,
		options?: RequestOptions
	): Promise<AccountResyncApiResponse> {
